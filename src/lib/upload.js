...
export function saveAudioFile(file) {
  // حداکثر ۲۵ مگابایت برای فایل صوتی
  return saveFile(file, "audio", AUDIO_EXT, 25 * 1024 * 1024);
}

export function saveCoverFile(file) {
  // حداکثر ۵ مگابایت برای کاور
  return saveFile(file, "covers", IMAGE_EXT, 5 * 1024 * 1024);
}
