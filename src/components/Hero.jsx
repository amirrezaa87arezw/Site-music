...
export default function Hero({ latestTrack, trackCount }) {
  ...
  return (
    <section className="relative min-h-[100svh] flex items-center overflow-hidden pt-24 md:pt-0">
      <Hero3D />

      {/* گرادیان‌های محو برای عمق بیشتر */}
      <div className="pointer-events-none absolute -top-32 -left-32 w-96 h-96 rounded-full bg-violet/30 blur-[120px]" />
      <div className="pointer-events-none absolute bottom-0 right-0 w-[28rem] h-[28rem] rounded-full bg-crimson/20 blur-[140px]" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full px-5 md:px-8 grid md:grid-cols-[1.3fr_0.7fr] gap-10 items-end pb-16 md:pb-24">
        ...
        >
          <p className="text-xs tracking-wide text-bone/60 mb-3">
            سایت رسمی · تهران، ایران
          </p>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 text-bone/40 text-xs">
