...
export default function TrackCard({ track }) {
  ...
  return (
    <div className="glass rounded-2xl p-3 flex items-center gap-4 hover:border-violet/50 transition-colors w-full border border-transparent">
      <button
        onClick={() => play(track)}
        className="focus-ring group flex items-center gap-4 flex-1 min-w-0 text-right"
      >
      ...
      <DownloadLinks track={track} className="shrink-0" />
    </div>
  );
}
